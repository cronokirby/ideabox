...
;require.register("elm/src/Main.elm", function(exports, require, module) {
...
var _cronokirby$ideabox$Main$main = _elm_lang$virtual_dom$Native_VirtualDom.staticProgram(
	_elm_lang$html$Html$text('Hello from Elm!'));

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _cronokirby$ideabox$Main$main !== 'undefined') {
    _cronokirby$ideabox$Main$main(Elm['Main'], 'Main', undefined);
}
